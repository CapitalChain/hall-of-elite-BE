 ...
 */
export declare function resolveMt5TraderIdForUser(ccUserId: string, selectedTraderId?: string | null, userEmail?: string | null): Promise<string | null>;
 ...
 */
export declare function getProgressForUser(userId: string, selectedTraderId?: string | null, userEmail?: string | null): Promise<UserProgressResponse>;
